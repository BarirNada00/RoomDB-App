...
public class AddNewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_ID = "ma.projet.android.wordlist.extraid";

    public static final String EXTRA_WORD = "ma.projet.android.wordlist.word";
    public static final String EXTRA_MEANING = "ma.projet.android.wordlist.meaning";
    public static final String EXTRA_TYPE = "ma.projet.android.wordlist.type";
